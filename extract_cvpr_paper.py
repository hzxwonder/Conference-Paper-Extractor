...
def getHTMLText(url):
    kv = {'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36'}
        ...
        for i in range(0, len(parse_xpaths), batch_size):
            ...
            for parse_xpath in tqdm(parse_xpaths_batch):
                ...
                try:
                    ...
                    abstract_text = meta_tag['content'].strip()
